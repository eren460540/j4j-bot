...
class J4J:
    ...
    async def _post(self, endpoint, body):
        ...
        async with aiohttp.ClientSession() as session:
            async with session.post(
                url,
                json=body,  # <- FIXED BODY, API NOW RECEIVES JSON
    ...
    # FIXED: Join4Join requires POST, not GET
